            ...
            public void onResponse(Call<List<ModelClass>> call, Response<List<ModelClass>> response) {
                ...
                for(int i=0; i<modelClassList.size(); i++){
                    if(modelClassList.get(i).getCountry().equals(country)){
                        ...
                        mactive.setText(NumberFormat.getInstance().format(modelClassList.get(i).getActive()));
                        mtodaydeaths.setText(NumberFormat.getInstance().format(modelClassList.get(i).getTodayDeaths()));
                        mtodayrecovered.setText(NumberFormat.getInstance().format(modelClassList.get(i).getTodayRecovered()));
                        mtodaytotal.setText(NumberFormat.getInstance().format(modelClassList.get(i).getTodayCases()));
